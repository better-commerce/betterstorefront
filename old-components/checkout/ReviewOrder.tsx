              ...
              <span className="font-medium text-black dark:text-black">
                ...
                <span className="block font-normal font-12 text-wrap-p">
                  ...
                  <span className="font-bold">
                    {new Date(basket?.estimatedDeliveryDate).getTime() > 0 ? eddDateFormat(basket?.estimatedDeliveryDate) : new Date(shippingMethod?.expectedDeliveryDate).getTime() > 0 ? eddDateFormat(shippingMethod?.expectedDeliveryDate) : ""}{' '}
                  </span>
                </span>
              </span>
