import { DeviceIdKey, NEXT_GET_CART, SessionIdCookieKey, } from '@new-components/utils/constants'
...
import { CheckoutStepType, LoadingActionType, NEXT_BASKET_VALIDATE, } from '@new-components/utils/constants'
...
import setSessionIdCookie, { getExpiry, getMinutesInDays } from '@new-components/utils/setSessionId'
