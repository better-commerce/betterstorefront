...
import { KEYS_MAP, EVENTS } from '@old-components/utils/dataLayer'
...
const BreadCrumbs = dynamic(() => import('@old-components/ui/BreadCrumbs'))
...
const Engraving = dynamic(() => import('@old-components/product/Engraving'))
const ProductDetails = dynamic(() => import('@old-components/product/ProductDetails'))
const Button = dynamic(() => import('@old-components/ui/IndigoButton'))
...
const QuantityBreak = dynamic(() => import('@old-components/product/ProductView/QuantiyBreak'))
...
export default function ProductView({ data = { images: [] }, snippets = [], recordEvent, slug, isPreview = false, relatedProductsProp, promotions, pdpCachedImages: cachedImages, reviews, deviceInfo, config, maxBasketItemsCount, allProductsByCategory: allProductsByCategoryProp, featureToggle, defaultDisplayMembership, }: any) {
  ...
  const detailsConfig = [
    { name: translate('common.label.descriptionText'), content: product?.shortDescription || 'No Data' },
