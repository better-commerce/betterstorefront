...
/**
 * Class {WishlistPageProps} inherits and implements the base behavior of {BasePagePropsProvider} and {IPagePropsProvider} respectively to return the PageProp values.
 */
export class WishlistPageProps extends BasePagePropsProvider implements IPagePropsProvider {
