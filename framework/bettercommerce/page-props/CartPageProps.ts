...
/**
 * Class {CartPageProps} inherits and implements the base behavior of {BasePagePropsProvider} and {IPagePropsProvider} respectively to return the cart PageProp values.
 */
export class CartPageProps extends BasePagePropsProvider implements IPagePropsProvider {
