...
export default async function useConvertOrder({ data, config, cookies, extras }: any) {
    let logData: any = {};
    let objectId = uuid();
    try {
        ...
        const paymentResponseResult = await new BetterCommerceOperation().convertOrder(params);
