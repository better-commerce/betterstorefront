                    ...
                    <div className="flex items-center justify-center min-h-full p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                ...
                                <p className="px-6 py-4 text-sm font-normal text-black">
                                ...
                                <div className="flex items-center justify-around w-full gap-2 px-6 pb-3">
                                    <button
                                        onClick={() => {
                                            closeModal()
                                        }}
                                    ...
                                    >
                                        {loadingAction === LoadingActionType.CREATE_BASKET ? (
                                            <><LoadingDots /> <span>{translate('common.label.submitText')}</span></>
                                        ) : (
