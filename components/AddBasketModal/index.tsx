                    ...
                    <div className="flex items-center justify-center min-h-full p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                ...
                                <p className="py-4 px-6 text-sm font-normal text-black">
                                ...
                                <div className="flex items-center justify-around w-full px-6 pb-3 gap-2">
                                    <button
                                        onClick={() => {
                                            closeModal()
                                        }}
                                        className="nc-Button relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6  ttnc-ButtonPrimary disabled:bg-opacity-90 bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 !text-slate-50 dark:text-slate-800 shadow-xl w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="nc-Button relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6  ttnc-ButtonPrimary disabled:bg-opacity-90 bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 !text-slate-50 dark:text-slate-800 shadow-xl w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0 disabled:cursor-not-allowed"
                                        disabled={!basketName}
                                    >
                                        {loadingAction === LoadingActionType.CREATE_BASKET ? (
                                            <LoadingDots />
                                        ) : (
