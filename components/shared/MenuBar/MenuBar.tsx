...
const MenuBar: React.FC<MenuBarProps> = ({ navItems, featureToggle }) => {
  ...
  return (
    <>
      <button onClick={handleOpenMenu} className="p-1.5 sm:p-2.5 rounded-lg text-neutral-700 dark:text-neutral-700 focus:outline-none flex items-center justify-center" >
