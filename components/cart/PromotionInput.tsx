        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-center items-center">
            ...
            <Button
              ...
              className={`max-w-xs flex-1 ml-5 bg-black border border-transparent rounded-sm uppercase py-2 px-4 flex items-center justify-center font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-black sm:w-full`}
            />
          </div>
        </div>
        {error ? (
