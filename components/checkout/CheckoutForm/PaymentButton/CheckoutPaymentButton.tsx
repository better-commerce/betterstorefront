          ...
          if (token) {
            const data: CheckoutPaymentRequest = {
              ...
              shipping: {
                address: {
                  address_line1:
                    basketOrderInfo?.shippingAddress?.address1 || EmptyString,
                  address_line2:
                    basketOrderInfo?.shippingAddress?.address2 || EmptyString,
                  city: basketOrderInfo?.shippingAddress?.city || EmptyString,
                  state: EmptyString,
                  zip:
                    basketOrderInfo?.shippingAddress?.postCode || EmptyString,
                  country:
                ...
                phone: {
                  country_code:
                    basketOrderInfo?.shippingAddress?.mobileCountryCode ||
                    BETTERCOMMERCE_DEFAULT_PHONE_COUNTRY_CODE,
                  number:
                    basketOrderInfo?.shippingAddress?.phoneNo || EmptyString,
                },
              },
