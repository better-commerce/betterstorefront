          ...
          <>
                    ...
                    >
                      ...
                      {formItem.addressFinder && itemsToHide.length > 0 ? (
                        <button
                          ...
                          style={{ maxWidth: '20%' }}
                          className="ml-3 mt-8 mb-8 max-w-xs flex-1 bg-black border border-transparent rounded-md py-2 px-1 flex items-center justify-center font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-800 sm:w-full"
                        >
                          {BTN_FIND}
                        </button>
                      ) : null}
            ...
            {!isGuest && (
              <div className="flex">
                <button
                  ...
                  className="max-w-xs m-2 flex-1 bg-black border border-transparent rounded-md py-3 px-8 flex items-center justify-center font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-800 sm:w-full"
                >
            ...
            <div className="mt-10 flex sm:flex-col1 w-full justify-center">
              <button
                ...
                className="max-w-xs flex-1 bg-black border border-transparent rounded-md py-3 px-8 flex items-center justify-center font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-800 sm:w-full"
              >
                {btnTitle}
              </button>
              {!!closeEditMode && (
                <button
                  ...
                  className="max-w-xs flex-1 bg-gray-500 border border-transparent rounded-md py-3 ml-5 px-8 flex items-center justify-center font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-800 sm:w-full"
                >
                  {GENERAL_CANCEL}
                </button>
              )}
