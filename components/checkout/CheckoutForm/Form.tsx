          ...
          <>
                    ...
                    >
                      <div>
                        ...
                        <Field
                          ...
                          className={
                            formItem.className ||
                            'relative mb-2 mt-2 appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-xs shadow-sm py-2 px-4 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-gray-800 focus:ring-1 focus:ring-gray-800 '
                          }
                        >
                      ...
                      {formItem.addressFinder && itemsToHide.length > 0 ? (
                        <button
                          ...
                          style={{ maxWidth: '20%' }}
                          className="ml-3 mt-8 mb-8 max-w-xs flex-1 bg-black border uppercase border-lime rounded-xs py-2 px-1 flex items-center justify-center font-medium text-lime hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-700 sm:w-full"
                        >
                          {BTN_FIND}
                        </button>
                      ) : null}
            ...
            <div className="mt-10 flex sm:flex-col1 w-full justify-center">
              <button
                ...
                className="max-w-xs flex-1 bg-black border uppercase border-lime rounded-xs py-3 px-8 flex items-center justify-center font-medium text-lime hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-700 sm:w-full"
              >
                {btnTitle}
              </button>
              {!!closeEditMode && (
