...
export default function CheckoutHeading() {
  return (
    <>
      <div className='w-full py-6 border-b border-black'>
        <div className='relative text-center container-ffx'>
          <h1 className='sr-only'>checkout</h1>
          <h2 className='flex items-center justify-end font-semibold mob-font-14 sm:justify-center dark:text-black mob-line-height-1 uppercase'>secure checkout <span><i className='ml-4 sprite-icons sprite-secure'></i></span></h2>
