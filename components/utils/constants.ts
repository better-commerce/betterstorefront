...
export const NEXT_GET_CUSOMER_BANK_LIST = '/api/customer-bank/get-customer-bank-list'
export const NEXT_BANK_TRANSFER = '/api/bank-transfers/create-bank-transfer'
