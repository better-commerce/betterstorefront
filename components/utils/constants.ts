...
export const B2B_COMPANY_HIERARCHY = `/admin/company-hierarchy`
export const B2B_COMPANY_HIERARCHY_BY_PARENT_ID = `/admin/company-hierarchy/by-company-parent`
...
export const NEXT_B2B_GET_COMPANY_DETAILS = `/api/b2b/get-company`
export const NEXT_B2B_GET_COMPANY_HIERARCHY = '/api/b2b/company-hierarchy'
export const NEXT_B2B_GET_COMPANY_HIERARCHY_BY_PARENT_ID = '/api/b2b/company-hierarchy-by-parentId'
export const NEXT_B2B_SAVE_QUOTE = `/api/b2b/save-quote`
