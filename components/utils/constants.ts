...
export const REGISTER_CUSTOMER = '/api/v1/commerce/customer/create'
export const AUTHENTICATE_CUSTOMER = '/api/v1/commerce/customer/authenticate'
export const CUSTOMER_BASE_API = '/api/v1/commerce/customer/'
export const CUSTOMER_NEWSLETTER =
  '/api/v1/commerce/customer/newsletter/subscribe'
export const ORDERS_ENDPOINT = '/api/v1/commerce/order/'
export const ADDRESS_ENDPOINT = '/api/v1/commerce/address/'
export const CREATE_ADDRESS_ENDPOINT = '/api/v1/commerce/address/create'
//LOCAL ENDPOINTS
