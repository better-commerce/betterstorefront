...
export const NEXT_GET_CUSOMER_BANK_LIST = '/api/wallet/customer-bank/get-customer-bank-list'
export const NEXT_BANK_TRANSFER = '/api/wallet/bank-transfers/create-bank-transfer'
