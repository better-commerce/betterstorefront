...
export const COPYRIGHT_FOOTER_INFO = '2022 BetterCommerce, Inc. All rights reserved.'
...
export const GENERAL_DELIVERY_RETURN = 'delivery & returns'
export const GENERAL_SIZE_GUIDE = 'size guide'