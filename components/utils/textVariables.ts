...
export const SIGN_UP_TEXT = 'The latest deals and savings, sent to your inbox weekly.'
...
export const VALIDATION_PLEASE_COMPLETE_THIS_FIELD = 'Please compelte this field'
export const GENERAL_ENGRAVING = 'Engraving'
export const GENERAL_ENGRAVING_PERSONALIZE_BOTTLE = 'Personalize your bottle for only'
...
export const PRICEMATCH_WEBSITE_NAME = 'Name of website you have found cheaper to*'
export const PRICEMATCH_PRODUCT_LINK = 'Full direct link to product (copy/paste website URL)*'
...
export const VALIDATION_NO_ACCOUNT_FOUND = 'No account has been found with this email/password'
...
export const ERROR_PAGE_NOT_FOUND_MESSAGE = "The requested page doesn't exist or you don't have access to it."
