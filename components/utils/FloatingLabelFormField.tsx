...
const DEFAULT_TYPES = ["text", "number", "password", "card-expiry-text", "tel", "date"];
        ...
        <>
            {
                DEFAULT_TYPES.includes(item?.type) && (
                    <div className={item?.floatingDivClassName ? item?.floatingDivClassName : "floating-label"}
                        key={key ?? item?.name}
                    >
                            ...
                            matchStrings(item?.type, "card-expiry-text", true) ? (
                                ...
                                matchStrings(item?.type, "date", true) ? (
                                    <Field
                                        ...
                                        min="1900-01-01"
                                        max="2100-01-01"
                                        value={context.values[item?.name] && context.values[item?.name]?.length > 0 ? context.values[item?.name] : ""}
                                        onChange={(e: any) => {
                        ...
                        <label hidden={item?.hidden ?? false} className={item?.labelClassName}>
                            {item?.label}
                            {
                                item?.required && (
                        ...
                        {((item?.required) || (item?.dependant && context.errors[item?.name])) && (
