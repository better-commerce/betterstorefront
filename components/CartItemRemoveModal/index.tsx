                                ...
                                <div className="flex items-center justify-around w-full px-6 mt-2">
                                    <button
                                        onClick={() => {
                                            ...
                                            handleItem(itemClicked?.product ?? itemClicked, 'delete')
                                        }}
                                        className="ttnc-ButtonPrimary button-oprimary disabled:bg-opacity-90 bg-slate-900 dark:bg-slate-900 hover:bg-slate-800 !text-slate-50 dark:text-slate-50 shadow-xl mt-4 w-full focus:outline-none focus:ring-2 focus:ring-offset-2"
                                    >
