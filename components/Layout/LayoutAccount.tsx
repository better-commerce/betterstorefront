  ...
  return (
    <>
      ...
      <CommerceProvider locale={locale}>
        ...
        <div className={`text-base sm:pt-20 pt-16 account-top-margin  account-main-bg-gradient dark:bg-neutral-900 dark-acc-white text-neutral-900 dark:text-neutral-200 ${featureToggle?.features?.enableForPCSite ? 'pading-top-cls' : ''}`}>
          ...
          <>
            ...
            <section className="container w-full pt-0 mt-0 sm:my-0 theme-account-container sm:pb-32 pc-b-padding-none">
              <div className='grid w-full aac-grid grid-cols-1 gap-6 mx-auto sm:grid-cols-12 sm:gap-10 pc-min-height-container mt-4'>
                <div className={`sticky z-10 top-7 sm:top-12 sm:col-span-3 pc-acc-3 ${featureToggle?.features?.enableForPCSite ? 'sidebar_bgs' : ''}`}>
                <SideMenu deviceInfo={deviceInfo} featureToggle={featureToggle} config={config} />
                </div>
                <div className='pt-0 px-3 sm:col-span-9 sm:pt-5 z-1 pc-acc-9'> {children} </div>
              </div>
            </section>
          </>
