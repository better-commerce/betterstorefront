  ...
  return (
    <>
      ...
      <CommerceProvider locale={locale}>
        ...
        <div className={`text-base sm:pt-20 pt-16 account-top-margin bg-white dark:bg-neutral-900 dark-acc-white text-neutral-900 dark:text-neutral-200 ${featureToggle?.features?.enableForPCSite ? 'pading-top-cls' : ''}`}>
