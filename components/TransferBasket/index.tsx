          ...
          <div className="flex items-center justify-center min-h-full p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md pb-6 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                <Dialog.Title
                  as="div"
                  className="flex items-center justify-between w-full px-6 py-3 text-lg font-medium leading-6 border-b-2 shadow text-gray-900/70 xsm:text-md border-gray-50"
                >
                ...
                <div className="flex items-center justify-around w-full gap-4 px-6 mt-6">
                  <button
                    onClick={() => {
                      closeModal()
                    }}
                     className="nc-Button relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6  ttnc-ButtonPrimary button-primary disabled:bg-opacity-90 bg-white dark:bg-slate-100 hover:bg-white !text-black border border-gray-300 hover:!border-gray-600 w-full"
                  >
