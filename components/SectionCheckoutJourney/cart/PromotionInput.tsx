          ...
          <div className="w-full">
            <div className="flex flex-col mt-0">
              <div className="flex items-center justify-between gap-2 mb-2 -mt-1 font-normal text-left cursor-text text">
                ...
                <button onClick={async () => await applyCouponInput('applyInput', value)} type="submit" title={translate('common.label.applyText')} className={`flex items-center justify-center btn btn-secondary button-secondary w-full btn-sm-cls !font-medium`} >
