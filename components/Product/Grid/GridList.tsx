          ...
          component={
            <div className={gridClass}>
              ...
              {products?.results?.map((product: any, productIdx: number) => (
                <ProductSearchCard data={product} deviceInfo={deviceInfo} maxBasketItemsCount={maxBasketItemsCount} key={`products-${productIdx}`} featureToggle={featureToggle} defaultDisplayMembership={defaultDisplayMembership} />
              ))}
            </div>
          }
        />
