...
const UsedProductCard = dynamic(() => import('@components/UsedProductCard'), { ssr: true })
...
function UsedProductGrid({ products, currentPage, handlePageChange = () => { }, handleInfiniteScroll,
          ...
          component={
            <div className={gridClass}>
              ...
              {products?.results?.map((product: any, productIdx: number) => (
                <UsedProductCard view="grid" data={product} deviceInfo={deviceInfo} maxBasketItemsCount={maxBasketItemsCount} key={`products-${productIdx}`} featureToggle={featureToggle} defaultDisplayMembership={defaultDisplayMembership} />
              ))}
            </div>
          }
        />
...
export default memo(UsedProductGrid)