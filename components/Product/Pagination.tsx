  ...
  return (
    <>
      <ReactPaginate
        ...
        pageLinkClassName={
          'inline-flex items-center px-2 pagination-custom h-8 sm:px-4 sm:h-10 border border-gray-300 rounded-md bg-white hover:bg-gray-100 focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-offset-1 focus:ring-offset-indigo-600 focus:ring-indigo-600 focus:ring-opacity-25'
        }
