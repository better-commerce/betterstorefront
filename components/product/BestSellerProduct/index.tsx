  ...
  return (
    ...
    <section className="pt-4 pb-8 sm:pt-16 vertical-prod-list-mob">
      <div className="container-ffx">
        <h2 className='flex flex-col justify-center w-full mb-3 sm:mb-10 font-bold text-left sm:text-center'>TO EACH HIS OWN SHARK</h2>
        <div className="flex justify-between gap-1 mb-2 lg:gap-3 sm:mb-0">
          <h3 className="mb-6 font-medium font-24 mob-font-16 dark:text-black text-left sm:text-center">DISCOVER OUR NEW PRODUCTS</h3>
        </div>
