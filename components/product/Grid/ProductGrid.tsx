    ...
    <>
      {IS_INFINITE_SCROLL && (
        <InfiniteScroll
          ...
          component={
            <div
              className={`p-[1px] border-gray-100 gap-x-4 gap-y-4 grid grid-cols-2 sm:mx-0 md:grid-cols-6 ${products?.results?.length < 6
                  ? `lg:grid-cols-6`
                  : 'lg:grid-cols-6'
                }`}
            >
      ...
      {!IS_INFINITE_SCROLL && (
        <>
          <div
            className={`p-[1px] border-gray-100 gap-x-4 gap-y-4 grid grid-cols-2 sm:mx-0 md:grid-cols-5 ${products?.results?.length < 6
                ? `lg:grid-cols-5`
                : 'lg:grid-cols-5'
              }`}
          >
