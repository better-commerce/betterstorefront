          ...
          <Form className="w-full font-semibold">
            ...
            <div className="mt-5 flex justify-center items-center">
              <button
                ...
                className="w-full max-w-xs flex-1 bg-black border border-transparent rounded-xs py-3 px-8 flex items-center justify-center font-medium text-lime hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-700 uppercase sm:w-full"
              >
