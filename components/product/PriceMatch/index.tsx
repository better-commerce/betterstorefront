...
export default function PriceMatch({
  ...
  return (
    <Transition.Root show={show} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto" onClose={() => onClose(false)}>
          ...
          <Transition.Child
            ...
            <div className="flex w-full text-base text-left transition transform md:inline-block md:max-w-2xl md:px-4 md:my-8 md:align-middle lg:max-w-4xl">
              <div className="relative flex items-center w-full px-4 pb-8 overflow-hidden bg-white shadow-2xl pt-14 sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                <button type="button" className="absolute text-gray-400 top-4 right-4 hover:text-gray-500 sm:top-8 sm:right-6 md:top-6 md:right-6 lg:top-8 lg:right-8" onClick={() => onClose(false)}>
                ...
                <section className="flex py-10">
                  <div className="w-1/2 p-2 bg-gray-50">
                    ...
                    <img src={productImage} className="object-cover object-top h-96 w-96" />
                    <p className="py-5 font-bold text-center text-black">{productName}</p>
                  </div>
                  <div className="w-1/2 px-5">
                    <p className="py-5 text-lg font-bold text-center text-black center">Contact</p>
