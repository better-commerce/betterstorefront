...
const LoginView: FC<React.PropsWithChildren<unknown>> = () => {
  ...
  return (
    <section aria-labelledby="trending-heading" className="bg-white h-screen overflow-y-auto">
      <div className="py-16 sm:py-24 lg:max-w-7xl lg:mx-auto lg:py-32 login-side-padding lg:px-8">
        ...
        <SocialSignInLinks isLoginSidebarOpen="isLoginSidebarOpen" containerCss="flex justify-center gap-1" />
