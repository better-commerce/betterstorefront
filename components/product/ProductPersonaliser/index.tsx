      ...
      {readOnly ? (
        <>
          ...
          <div className="px-4 m-auto xsm:p-3">
            <p className="mb-3 text-black xsm:text-sm xsm:flex dark:text-black"><span className='text-2xl text-gray-500'>Message</span> : <span className='text-2xl'>{text}</span></p>
          </div>
        </>
      ) : (
        <>
