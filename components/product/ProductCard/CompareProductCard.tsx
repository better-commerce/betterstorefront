...
const CompareProductCard: FC<React.PropsWithChildren<Props & IExtraProps>> = ({
  ...
  return (
    <>
      <div
        className={cn(
          'relative height-full border-gray-200 hover:border-gray-500 grid grid-cols-12 gap-2 sm:gap-0 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 shadow-gray-200 group prod-group border rounded-md px-4 pt-4 pb-4 sm:pb-0 bg-white',
