...
export default function FiltersRightOpen({ products = { filters: [] }, handleSortBy, routerFilters, clearAll, routerSortOption, }: Props) {
  ...
  return (
    <section aria-labelledby="filter-heading" className="items-center justify-between flex-1 hidden max-w-3xl py-1 text-center sm:mb-0 sm:flex sm:pl-2 lg:max-w-7xl lg:pl-4">
