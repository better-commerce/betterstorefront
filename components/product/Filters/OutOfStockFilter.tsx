...
const OutOfStockFilter: React.FC<OutOfStockFilterProps> = ({
  ...
  return (
    <>
      <div className="flex flex-col py-0 pr-1 text-xs font-normal text-black font-14 whitespace-nowrap dark:text-white"> {translate('label.search.includeOOSProductsText')} </div>
