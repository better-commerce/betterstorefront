   ...
   return (
      <>
         <Transition.Root show={isOffers} as={Fragment}>
            <Dialog as="div" className="relative z-50" onClose={() => setOffers(!isOffers)}>
                                    ...
                                    <div className="flex flex-col w-full">
                                       <div className="w-full">
                                          ...
                                          >
                                             ...
                                             <XMarkIcon className="relative w-6 h-6 sm:w-8 sm:h-8 sm:top-1" aria-hidden="true" />
                                          </button>
                                       </div>
                                       <div className="w-full">
                                          <h3 className="font-bold text-20 sm-text-16 text-gray-dark">  Offer Details</h3>
                                       </div>
                                    </div>
                                 </div>
                                          ...
                                          {data ? (
                                             <>
                                                <div className="flex-1 image-container">
                                                   <Image alt="Offers" src={data?.additionalInfo5} width={318} height={196} layout="responsive" className="image" />
                                                </div>
                                                <div className="flex-1 mt-6">
                                                   <p className="text-sm font-normal text-black">
                                                      <div
                                                         className="text-sm font-normal leading-7 text-brown"
                                                         dangerouslySetInnerHTML={{ __html: data?.additionalInfo4 || data?.additionalInfo4 }}
                                                      />
                                                   </p>
                                                </div>
                                             </>
