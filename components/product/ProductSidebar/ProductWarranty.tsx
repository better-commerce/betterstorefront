                                ...
                                >
                                  ...
                                  '30 Day 1st Try Guarantee' ? (
                                    <div className="w-full">
                                      <div className="flex-1 mt-6">
                                        <p className="text-sm font-normal text-black">
                                          Damensch believes in a world driven by
                                          comfort. Which means if you're a first
                                          time customer of our innerwear
                                          products and find the size, colour or
                                          fit not to your liking and comfort
                                          then we’ll send a replacement for the
                                          same product in your preferred size.
                                          If you’re not satisfied with the
                                          product, we’ll give you a full refund
                                          for the first product. Read details
                                          below:
                                        </p>
                                      </div>
                                      <div className="flex-1 mt-4">
                                        ...
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (1) First innerwear purchase from
                                          DaMENSCH{' '}
                                        </p>
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (2) One single innerwear product{' '}
                                        </p>
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (3) Colour fading, wrong colour, wrong
                                          size, manufacturing defect, delivery
                                          defect
                                        </p>
                                        ...
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (1) More than one product and/or
                                          consecutive purchase form DaMENSCH
                                        </p>
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (2) Innerwear packs of 2 or more (If
                                          you’ve bought a pack of 2 or more,
                                          only one product from the pack will be
                                          eligible for refund, while the others
                                          qualify for exchange only if it is
                                          unused and kept in the original
                                          delivery condition){' '}
                                        </p>
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (3) Defects noticed after 30 days from
                                          purchase
                                        </p>
                                        <p className="my-2 mt-4 text-sm font-normal text-black">
                                        ...
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          The 30 Day First Try Guarantee covers
                                          refund or replacement only on the
                                          innerwear product purchase. Any
                                          innerwear product that has been tried
                                          on or washed need not be returned.
                                          Simply raise a request with your
                                          product defect or issue with a clear
                                          photograph of the same and we’ll send
                                          a replacement your way.{' '}
                                        </p>
                                      </div>
                                    </div>
                                  ) : (
                                    <>
                                      <div className="flex-1 mt-6">
                                        <p className="text-sm font-normal text-black">
                                          Please note that this warranty is
                                          valid only for one replacement, in the
                                          case of wear and tear in the t-shirt
                                          after regular usage.
                                        </p>
                                      </div>
                                      <div className="flex-1 mt-4">
                                        ...
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (1) Tears, rips or snags caused by
                                          external objects
                                        </p>
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (2) Damage caused by chlorine, heat,
                                          gas, bleach or any liquid above 50°C{' '}
                                        </p>
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          (3) The product is purchased from an
                                          unauthorised dealer
                                        </p>
                                        <p className="my-1 text-xs font-normal text-gray-400">
                                          Head over to the FAQ section to find
                                          out more
                                        </p>
                                      </div>
                                    </>
