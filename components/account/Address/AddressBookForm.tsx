            ...
            <div className="mt-10 flex sm:flex-col1 w-1/2">
              ...
              {!!closeEditMode && (
                <button
                  ...
                  className="max-w-xs flex-1 bg-gray-500 border border-lime rounded-xs py-3 ml-5 px-8 flex items-center justify-center font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 sm:w-full"
                >
                  {GENERAL_CANCEL}
                </button>
              )}
