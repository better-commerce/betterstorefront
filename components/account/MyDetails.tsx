              ...
              <div className="flex-col w-full py-5 flex items-flex-start mx-auto max-w-4xl justify-center">
                ...
                <div className="mt-10 flex sm:flex-col1">
                  <button
                    ...
                    className="max-w-xs flex-1 bg-black border border-transparent rounded-md py-3 px-8 flex items-center justify-center font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
                  >
