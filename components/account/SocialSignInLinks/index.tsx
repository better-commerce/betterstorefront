...
const SocialSignInLinks = ({ containerCss, isLoginSidebarOpen }: any) => {
  return (
    <div className={containerCss}>
      ...
      >
        <a className={`w-full px-6 py-4 text-sm font-medium text-center text-white bg-red-500 ${isLoginSidebarOpen =='isLoginSidebarOpen' && `!px-0 !py-3`}`}>
          <svg
      ...
      >
        <a className={`w-full px-6 py-4 text-sm font-medium text-center text-white bg-sky-600 ${isLoginSidebarOpen =='isLoginSidebarOpen' && `!px-0 !py-3 !pl-1 !pr-1`}`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <a className={`w-full px-6 py-4 text-sm font-medium text-center text-white bg-black ${isLoginSidebarOpen =='isLoginSidebarOpen' && `!px-0 !py-3`}`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
