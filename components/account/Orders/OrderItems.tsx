                    ...
                    <div>
                      <div className="flex flex-col justify-between font-medium text-gray-900">
                        <div className="flex items-center justify-between w-full">
                          ...
                          {
                            !ifItemCancelled ? (
                              <a onClick={() => openHelpModal(productItem, details?.order)} className="text-sm font-bold cursor-pointer text-orange" >
                                Help?
                              </a>
                            ) : (
                              <label className={`px-4 py-3 text-sm font-bold leading-none ${itemStatusCss}`} >
                                {itemStatus}
                              </label>
                            )
                          }
