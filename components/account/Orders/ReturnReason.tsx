                ...
                <div className='mx-auto cancel-continer'>
                    ...
                    <div className='w-full py-4'>
                                    ...
                                    <div className="paymentBox paymentbox-sec">
                                        <div className="methodName">
                                            <label className="control control--radio">
                                                <input name="reason" type="radio" value={returnReason?.itemValue} className='pay-inpt' />
                                                <div className="py-2 control__indicator border-bottom-only">
                                                    <div className="relative w-full py-2 pl-0 pr-2">
                                                        <span className="block text-sm font-light text-primary">{returnReason?.itemText}</span>
                        ...
                        <div className='w-full'>
                            ...
                            <p className='text-sm mb-1 text-gray-700'>This will help us to identify your problem better</p>
                        ...
                        <div className='py-0'>
                            <p className='relative info-text py-4 text-gray-600'>
                                ...
                                <span className='text-sm font-normal'>
                                    {' '}
                                    Refund of {CURRENCY_SYMBOL_POUND}{item?.price?.raw?.withTax * qty} will be processed within 3-5 business days after the item is received and inspected.
                                </span>
                            </p>
                            <p className='relative pt-0 pb-4 text-sm info-text'><b>Note:</b> Please keep the items in their original condition with the MRP tag intact.</p>
                            <Button
                                type="button"
                                        ...
                                        <div className="relative z-50 flex flex-col h-full">
                                            <div className="w-full sm:z-10 sm:left-1 sm:top-1">
                                                <div className='flex justify-between px-4 py-3 border-b'>
                                                    <div>
                                                        <h3 className="text-base font-bold text-black dark:text-black">Return item </h3>
                                                    </div>
                                                    <button
                                                        type="button"
                                                ...
                                                <div className="w-full p-6 overflow-y-auto">
                                                    <div className='w-full'>
                                                        <p className='text-sm text-black'>Are you certain you want to return this item? {/*You'll miss out on savings of ₹648!*/}</p>
                                                    </div>
                                                    <div className='w-full'>
                                                    </div>
                                                    ...
                                                    <div className='w-full py-4'>
                                                        ...
                                                        >
                                                            {itemReturnLoadingState ? <LoadingDots /> : "Return Item"}
                                                        </Button>
                                                    </div>
                                                </div>
                                            </div>
