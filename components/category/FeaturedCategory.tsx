            ...
            {featured?.isFeatured == true && (
              <SwiperSlide key={featuredIdx}>
                <div className="relative border group rounded-2xl bg-slate-100 border-slate-100 hover:bg-slate-50">
                  <Link href={`/${featured?.link}`} className="flex justify-center w-full px-4 py-2 font-semibold text-center text-black bg-gray-100 border border-gray-100 rounded-lg hover:bg-gray-200 font-14">
