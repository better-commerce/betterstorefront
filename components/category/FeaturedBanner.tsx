    ...
    <>
      {category && category?.images && category?.images.length > 0 &&
        <div className="py-0 mx-auto">
          <Swiper spaceBetween={16} slidesPerView={1} navigation={true} loop={true} breakpoints={{ 640: { slidesPerView: 1, }, 768: { slidesPerView: 1, }, 1024: { slidesPerView: 2 }, 1400: { slidesPerView: 2 }, }} className="mySwier" >
              ...
              <SwiperSlide key={idx}>
                <div className='mt-4 sm:mt-8 category-banner-container'>
                  <div className="flex items-center justify-center order-2 w-full h-full bg-blue-web sm:order-1">
                    <div className="relative pos-absolute z-10 justify-center w-full sm:absolute top-space-mobile sm:top-2/4 sm:-translate-y-2/4 cat-container">
