    ...
    <section className='relative w-full bg-header-color' key={headIdx}>
      <div className='grid grid-cols-1 gap-0 mx-auto container-ffx sm:overflow-hidden sm:grid-cols-12'>
        <div className='flex flex-col justify-center h-full py-6 text-left left-info sm:col-span-5 sm:py-0'>
          <h1 className="text-white heading-h1 dark:text-white font-semibold sm:tracking-[7.2px] tracking-wider uppercase">{header?.hero_title}</h1>
          <div className="py-2 text-white dark:text-white font-46 banner-subheading page-list-bullet heading-h3" dangerouslySetInnerHTML={{ __html: header?.hero_description }}></div>
        </div>
