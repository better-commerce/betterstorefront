...
//   const elasticSearch = (
//     <SearchProvider config={elasticConfig}>
//       <div className="flex flex-row w-full rounded-sm sm:pr-4 mobile-search-ui">
//         <div
//           className="relative items-start w-full pr-3 text-left text-gray-400 sm:p-1 hover:text-gray-500 search-input-icon"
//           aria-label="Search"
//         >
...
//   )
//   const instantSearch = (
//     <div className="flex flex-row w-full rounded-sm instant-search-bar sm:pr-4 mobile-search-ui search-input-icon">
