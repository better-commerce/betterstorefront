...
const SearchBar: FC<React.PropsWithChildren<ISearchBarProps>> = ({
  ...
  const defaultSearch = (
    <>
      <div className="items-center justify-center hidden w-10 h-10 rounded-full lg:flex sm:w-12 sm:h-12 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none" onClick={onClick}>
