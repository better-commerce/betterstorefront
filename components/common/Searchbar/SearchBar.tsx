...
//   const elasticSearch = (
//     <SearchProvider config={elasticConfig}>
//       <div className="flex flex-row w-full rounded-sm sm:pr-4 mobile-serach-ui">
//         <div
...
//   )
//   const instantSearch = (
//     <div className="flex flex-row w-full rounded-sm instant-search-bar sm:pr-4 mobile-serach-ui search-input-icon">
