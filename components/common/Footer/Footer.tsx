      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border-t border-black py-20">
          <div className="grid grid-cols-1 md:grid-cols-12 md:grid-flow-col md:gap-x-8 md:gap-y-16 md:auto-rows-min">
            ...
            {/* Sitemap sections */}
            <div className="mt-10 col-span-5 grid grid-cols-2 gap-8 sm:grid-cols-3 md:mt-0 md:row-start-1 md:col-start-3 md:col-span-8 lg:col-start-3 lg:col-span-6">
                                ...
                                (navItem: any, navItemIdx: number) => {
                                  return (
                                    <li
                                      ...
                                      className="text-sm"
                                    >
                                      <span className="text-gray-100 hover:text-gray-200 cursor-hand">
                                        {navItem.caption}
                                      </span>
                                    </li>
                                  )
            ...
            <div className="mt-12 md:mt-0 md:row-start-2 md:col-start-3 md:col-span-8 lg:row-start-1 lg:col-start-9 lg:col-span-4">
              ...
              <form className="mt-2 flex sm:max-w-md">
                ...
                <div className="ml-4 flex-shrink-0">
                  <button
                    type="submit"
                    className="w-full bg-white border border-transparent rounded-xs shadow-sm py-2 px-4 flex items-center justify-center text-black font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    {BTN_SIGN_UP}
                  </button>
                </div>
