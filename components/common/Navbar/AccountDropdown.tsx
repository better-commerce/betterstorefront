    ...
    <Menu as="div" className="relative inline-block text-left border-r border-l border-lime-light">
      <Menu.Button className="px-2 sm:px-4 grid grid-cols-1 text-center text-lime hover:text-gray-100 inline-flex justify-center w-full focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
        ...
        <UserIcon
          ...
          aria-hidden="true"
        />
        <span className='text-lime pr-2 font-normal text-sm hidden sm:block'>My Account</span>
      </Menu.Button>
      <Transition
        as={Fragment}
      ...
      >
        <Menu.Items className="absolute z-50 right-0 w-56 mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-xs border border-lime shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="px-1 py-1 flex flex-col text-black divide-y divide-gray-100">
            <Menu.Item>
              {({ active }) => {
                return (
                  <>
