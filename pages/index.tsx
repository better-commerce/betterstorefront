    ...
    <>
      ...
      <div className="relative overflow-hidden nc-PageHome homepage-main dark:bg-white">
        ...
        <>
          ...
          {pageContents?.allproducts?.length > 0 &&
            <div className='container flex flex-col pt-5 mx-auto bg-white sm:pt-10'>
              <SectionSliderProductCard onlyImage={false} deviceInfo={deviceInfo} data={pageContents?.allproducts} heading={pageContents?.productheading} featureToggle={featureToggle} defaultDisplayMembership={defaultDisplayMembership} />
            </div>
          }
