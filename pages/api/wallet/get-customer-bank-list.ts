...
import getCustomerBankList from '@framework/wallet/get-customer-bank-list';
...
const getCustomerWalletTransactionByIdApiMiddleware = async (req: any, res: any) => {
  ...
  try {
    ...
    const response: any = await getCustomerBankList(walletId, { page, pageSize, sortBy, sortDescending, filters }, req?.cookies);
