  ...
  return (
    <>
      ...
      <div className="container py-6 mx-auto mt-6 cart-recently-viewed sm:py-10 sm:mt-10">
        ...
        <EngageProductCard productLimit={12} type={EngageEventTypes.ALSO_BOUGHT} campaignData={campaignData} title="Trending" isSlider={false} sku="SS23072-YELMULT-24" productPerRow={5} />
