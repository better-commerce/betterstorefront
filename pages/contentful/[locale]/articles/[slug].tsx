...
import { PageLink } from '@components/contentful/page-link'
import { PageHead } from '@components/contentful/page-head'
import { PageContentTypes } from '@lib/contentful/constants'
import { getPage, getPagesOfType } from '@lib/contentful/api'
import { RelatedPages } from '@components/contentful/RelatedPages'
import { MobileNavigation } from '@components/contentful/mobile-navigation'
import { BlockRenderer } from '@components/contentful/renderer/block-renderer'
import { TypePage, TypePage_help_center_article } from '@lib/contentful/types'
...
const NoBodyAlert = () => {
  return (
    ...
    >
      ...
      <span>
        Looks like the article content is missing, please add one and try again.
      </span>
    </div>
  )
}
