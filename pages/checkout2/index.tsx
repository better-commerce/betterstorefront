...
import LoginOrGuest from '@components/checkout2/LoginOrGuest'
import ShippingAddressForm from '@components/checkout2/ShippingAddressForm'
import BillingAddressForm from '@components/checkout2/BillingAddressForm'
import AddressBook from '@components/checkout2/AddressBook'
import DeliveryMethodSelection from '@components/checkout2/DeliveryMethodSelection'
import ReviewOrder from '@components/checkout2/ReviewOrder'
import PaymentMethodSelection from '@components/checkout2/PaymentMethodSelection'
import BasketDetails from '@components/checkout2/BasketDetails'
...
const CheckoutPage: React.FC = ({ appConfig, deviceInfo }: any) => {
  ...
  const goToStep = (step: string) => {
    ...
    router.push(`/checkout2?step=${step}`, undefined, {
      shallow: true,
      scroll: true,
    })
  }
  ...
  useEffect(() => {
    ...
    router.events.on('routeChangeStart', (newUrl: string, options: any) => {
      if (newUrl?.indexOf(`/checkout2?step=`) !== -1) {
