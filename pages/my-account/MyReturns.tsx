      ...
      <div className="w-full px-0 mx-auto sm:container sm:px-0 lg:px-0">
        <div className="px-2 py-4 mb-4 border-b mob-header md:hidden full-m-header">
          <h3 className="flex max-w-4xl gap-1 mx-5 mt-2 text-xl font-semibold text-black">
            ...
            <a className="mx-2 mr-2 leading-none" href="/my-account">My Return</a>
          </h3>
        </div>
              ...
              {config.map((item: any, idx: number) => (
                <>
                  ...
                  >
                    ...
                    {item.text == 'My Returns' ? (
                      <>
                        <div
                          key={`my-acc-${idx}`}
                          className={`relative ring-opacity-60 border-b border-slate-300 sm:border-0 cursor-pointer ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2  w-full text-14  leading-5 text-left pl-2 ${item.text == 'My Returns'
                          ...
                          <Link
                            ...
                            <span className='inline-block text-black sm:hidden dark:text-black'>{item.mtext}</span>
                            <span className={`hidden sm:inline-block text-black dark:text-black ${item.text == 'My Returns' && 'font-display'}`}>{item.text}</span>
                      ...
                      <>
                        <Link
                          ...
                          <span className={`hidden sm:inline-block text-black dark:text-black ${item.text == 'My Returns' && 'font-display'}`}>
                            {item.text}
                          </span>
